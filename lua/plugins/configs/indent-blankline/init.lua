vim.g.indent_blankline_filetype_exclude = {'dashboard', 'WhichKey', 'packer', 'help'}
...
vim.g.indent_blankline_context_patterns = {'class', 'function', 'method', '^if', '^while', '^for', '^object', '^table', '^try', '^do', 'block', 'arguments'}
