...
--     local hl = "hi " .. group .. " " .. cterm .. " " .. gui .. " " .. fg .. " " .. bg .. " " .. sp
--     vim.cmd(hl)
--
--     if color.link then
...
local function highlight(group, color)
    local fg = color.guifg or "NONE"
    local bg = color.guibg or "NONE"
    local gui = color.gui or "NONE"
    if color.gui and color.gui ~= "" then
        local guisp = color.guisp or "NONE"
        vim.cmd(string.format("hi %s guifg=%s guibg=%s gui=%s guisp=%s", group, fg, bg, gui, guisp))
    else
        vim.cmd(string.format("hi %s guifg=%s guibg=%s gui=%s", group, fg, bg, gui))
    end
end
...
M.gen_highlights = function()
    ...
    M.groups = {
        ...
        DiagnosticUnderlineWarn = { gui = "undercurl", sp = c.warn },
        DiagnosticUnderlineHint = { gui = "undercurl", sp = c.hint },
        DiagnosticUnderlineInfo = { gui = "undercurl", sp = c.info },

        -- Bufferline
        BufferLineBufferSelected = { gui = "bold" },

        -- Feline
        FlnViBlack = { fg = c.white, bg = c.black, gui = "bold" },
        FlnViRed = { fg = c.statusline_bg, bg = c.red, gui = "bold" },
        FlnViGreen = { fg = c.statusline_bg, bg = c.green, gui = "bold" },
        FlnViYellow = { fg = c.statusline_bg, bg = c.yellow, gui = "bold" },
        FlnViBlue = { fg = c.statusline_bg, bg = c.blue, gui = "bold" },
        FlnViMagenta = { fg = c.statusline_bg, bg = c.magenta, gui = "bold" },
        FlnViCyan = { fg = c.statusline_bg, bg = c.cyan, gui = "bold" },
        FlnViWhite = { fg = c.statusline_bg, bg = c.white, gui = "bold" },
        ...
        FlnStatus = { fg = c.statusline_fg, bg = c.statusline_bg, gui = "bold" },

        FlnText = { fg = c.statusline_fg, bg = c.statusline_bg },
        FlnBoldText = { fg = c.statusline_fg, bg = c.statusline_bg, gui = "bold" },
