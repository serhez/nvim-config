...
function M.setup()
	...
	require("nvim-navic").setup({
		icons = {
			...
			Field = icons.bracketed_prism .. icons.single_space,
			...
			Variable = icons.prism .. icons.single_space,
		...
		separator = icons.single_space .. icons.arrow.right_tall .. icons.single_space,
		highlight = true,
		depth_limit = 6,
